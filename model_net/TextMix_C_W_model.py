...
if __name__=="__main__":
	...
	input_x_char = tf.placeholder(tf.int32, [4, config.seq_length], name='input_x')
	input_x_word = tf.placeholder(tf.float32, [4, config.seq_length, config.word2vec_size], name='input_x')
